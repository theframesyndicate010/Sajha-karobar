            ...
            <tr class="hover:bg-gray-50 transition">
                <td class="px-6 py-4">
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 rounded-full bg-gradient-to-br from-[#2563eb] to-[#2563eb] flex items-center justify-center text-white font-bold text-sm">
                            ${initials}
                        </div>
                        <div>
                ...
                <td class="px-6 py-4 text-center">
                    <div class="flex items-center justify-center gap-1">
                        ...
                        <button onclick="editWorker('${worker.id}')" class="p-2 text-[#2563eb] hover:bg-slate-50 rounded-lg transition" title="Edit">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </button>
                        <button onclick="openPayModal('${worker.id}')" class="p-2 text-[#2563eb] hover:bg-slate-50 rounded-lg transition" title="Pay Salary">
                            <i class="fa-solid fa-indian-rupee-sign"></i>
                        </button>
                        <button onclick="deleteWorker('${worker.id}', '${escapeHtml(worker.name)}')" class="p-2 text-[#2563eb] hover:bg-slate-50 rounded-lg transition" title="Remove">
        ...
        <tr>
            <td colspan="7" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <button onclick="openAddWorkerModal()" class="mt-4 inline-flex items-center gap-2 bg-[#2563eb] hover:bg-[#1e40af] text-white font-semibold py-2 px-4 rounded-lg transition">
...
function viewWorker(workerId) {
    ...
    document.getElementById('viewWorkerContent').innerHTML = `
        <div class="flex items-center gap-4 mb-6">
            <div class="h-20 w-20 rounded-full bg-gradient-to-br from-[#2563eb] to-[#2563eb] flex items-center justify-center text-white font-bold text-2xl">
                ${initials}
            </div>
            <div>
        ...
        <div class="mt-6 bg-gray-50 rounded-xl p-5">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-lg p-4 text-center">
                    ...
                    <p class="text-xl font-bold text-[#2563eb]">₹${totalSalary.toLocaleString('en-IN')}</p>
                </div>
                <div class="bg-white rounded-lg p-4 text-center">
