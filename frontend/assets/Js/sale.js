        ...
        tbody.innerHTML = sales.map((sale, idx) => {
            ...
            return `
                <tr class="hover:bg-gray-50 transition group" data-sale-id="${sale.id}">
                    <td class="py-4 px-6 font-medium text-[#7C3AED]">#SALE-${String(sale.id).slice(-4).padStart(4, '0')}</td>
                    <td class="py-4 px-6">
                    ...
                    <td class="py-4 px-6">
                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-slate-50 text-[#581C87] border border-slate-200">
                            Sale
                        </span>
                    </td>
                    ...
                    <td class="py-4 px-6 text-right">
                        <div class="flex justify-end gap-2">
                            <button class="text-gray-400 hover:text-[#7C3AED] p-1 transition" title="Print" onclick="printSaleReceipt(${idx})">
                                <i class="fa-solid fa-print text-xs"></i>
                            </button>
                            <button class="text-gray-400 hover:text-[#7C3AED] p-1 transition" title="View Details">
                                <i class="fa-solid fa-eye text-xs"></i>
                            </button>
                            <button class="text-gray-400 hover:text-[#7C3AED] p-1 transition" title="Delete" onclick="deleteSaleRecord('${sale.id}')">
...
function renderSaleItems() {
    ...
    tbody.innerHTML = saleItems.map((item, index) => `
        <tr class="hover:bg-gray-50">
            ...
            <td class="py-3 px-4 text-center">
                <button onclick="removeItem(${index})" class="text-[#7C3AED] hover:text-[#581C87] hover:bg-slate-50 p-2 rounded-lg transition">
        ...
        content.innerHTML = `
            <div class="space-y-4">
                <div class="flex justify-between items-center pb-4 border-b">
                    <span class="text-2xl font-bold text-[#7C3AED]">${saleData.id}</span>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-bold text-lg text-[#7C3AED]">${saleData.total}</p>
                    </div>
                </div>
            </div>
        `;
