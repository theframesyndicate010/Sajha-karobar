    ...
    const sidebarHTML = `
        ...
        <aside id="sidebar" class="fixed lg:static inset-y-0 left-0 z-30 w-64 bg-white border-r border-gray-200 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 flex flex-col h-full shadow-xl lg:shadow-none">
            ...
            <div class="p-4 border-t border-gray-100">
                <a href="#" class="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-green-50 hover:text-green-600 rounded-xl font-medium transition duration-200 opacity-50 cursor-not-allowed" title="Coming Soon">
                    <i class="fa-solid fa-gear w-5 text-center"></i> Settings
                </a>
                <a href="#" onclick="logout()" class="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-green-50 hover:text-green-600 rounded-xl font-medium transition duration-200">
